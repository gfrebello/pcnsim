...
void RouteReply::copy(const RouteReply& other)
{
    ...
    this->routingFee = other.routingFee;
...
void RouteReply::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->routingFee);
...
void RouteReply::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->routingFee);
    doParsimUnpacking(b,this->messageType);
}

int RouteReply::getOrigin() const
{
    return this->origin;
}

void RouteReply::setOrigin(int origin)
{
    this->origin = origin;
}

double RouteReply::getRoutingFee() const
{
    return this->routingFee;
}

void RouteReply::setRoutingFee(double routingFee)
{
    this->routingFee = routingFee;
}

int RouteReply::getMessageType() const
{
    return this->messageType;
}

void RouteReply::setMessageType(int messageType)
{
...
RouteReplyDescriptor::RouteReplyDescriptor() : omnetpp::cClassDescriptor("RouteReply", "omnetpp::cPacket")
{
...
int RouteReplyDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "routingFee")==0) return base+1;
...
int RouteReplyDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    RouteReply *pp = (RouteReply *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *RouteReplyDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string RouteReplyDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: return double2string(pp->getRoutingFee());
        case 2: return long2string(pp->getMessageType());
        default: return "";
    }
}

bool RouteReplyDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: pp->setRoutingFee(string2double(value)); return true;
...
void *RouteReplyDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
